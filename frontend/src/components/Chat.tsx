          ...
          setMessages(prev => {
            ...
            if (last?.role === 'assistant') {
              updated[updated.length - 1] = {
                ...last,
                content: `![Generated image](${event.url})\n\n*Generated with DALL-E 3*`,
              }
            }
            return updated
          })
  ...
  return (
    <div className="flex h-full bg-zinc-950">
      ...
      <div className="flex flex-col flex-1 min-w-0 h-full">
        ...
        {isGeneratingImage && (
          <div className="flex items-center gap-2 px-6 py-2 bg-violet-950/30 border-b border-violet-900/40">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-3.5 h-3.5 text-violet-400 animate-pulse">
              <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
            </svg>
            <span className="text-xs text-violet-400 font-medium">Generating image with DALL-E 3…</span>
          </div>
        )}
