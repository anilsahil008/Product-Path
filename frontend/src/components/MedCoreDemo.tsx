...
const STATES: StateData[] = [
  ...
  // ── Additional 26 states + DC ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  { state: 'Alabama',         abbr: 'AL', evvModel: 'Provider Choice', evvVendor: 'Sandata',                  sdoh: false, hcbs: true,  mcPct: '~80%', mcos: ['Southeast Community Care', 'Live Well (PASSE)', 'Viva Health'],  notes: 'PASSE model (Provider-led shared savings) · No Medicaid expansion · Unique high-need MCO structure', expansion: false, fpl: '~18% FPL (parents)',  mcoModel: 'Statewide (PASSE)',            planCount: 5  },
  { state: 'Arkansas',        abbr: 'AR', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~60%', mcos: ['Centene (Arkansas Total Care)', 'Molina', 'Ambetter'],          notes: 'Arkansas Works expansion · Concurrent managed care + fee-for-service · SDOH required',           expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide (4 regional models)', planCount: 4  },
  { state: 'Delaware',        abbr: 'DE', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~85%', mcos: ['Centene (DE Community Care)', 'Highmark', 'Aetna Better Health'], notes: 'Diamond State Health Plan · SDOH required · Small state, high MC penetration',                   expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide (3 regions)',         planCount: 3  },
  { state: 'Hawaii',          abbr: 'HI', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~92%', mcos: ['UHC (QUEST)', 'Molina', 'Aloha Care', 'Ohana Health Plan'],     notes: 'QUEST Integration — one of longest-running managed care programs · Nearly all Medicaid in MC',    expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 4  },
  { state: 'Idaho',           abbr: 'ID', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: false, hcbs: true,  mcPct: '~75%', mcos: ['Molina', 'Blue Cross of Idaho', 'SelectHealth'],                 notes: 'Idaho Medicaid Plus · Ballot initiative expansion 2018 (effective 2020) · SDOH not yet required', expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'Iowa',            abbr: 'IA', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~93%', mcos: ['Centene (Iowa Total Care)', 'Molina', 'UHC (Amerigroup Iowa)'],  notes: 'Iowa Medicaid Enterprise · SDOH required · Very high managed care penetration',                   expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'Maryland',        abbr: 'MD', evvModel: 'Open',            evvVendor: 'HHAeXchange',              sdoh: true,  hcbs: true,  mcPct: '~82%', mcos: ['Amerigroup', 'Aetna Better Health', 'CareFirst', 'Molina', 'UHC'], notes: 'HealthChoice program · SDOH required · Strong BH parity requirements · High dual eligible pop',   expansion: true,  fpl: '138% FPL',            mcoModel: 'Regional',                     planCount: 8  },
  { state: 'Massachusetts',   abbr: 'MA', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~60%', mcos: ['Tufts Health Together', 'BMC HealthNet', 'Fallon Health', 'Molina'], notes: 'MassHealth · Pre-ACA expansion pioneer · 1115 waiver · ACO model alongside managed care',          expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide (+ ACO model)',      planCount: 6  },
  { state: 'Minnesota',       abbr: 'MN', evvModel: 'Open',            evvVendor: 'Sandata / HHAeXchange',    sdoh: true,  hcbs: true,  mcPct: '~70%', mcos: ['UCare', 'Blue Plus', 'Medica', 'HealthPartners', 'South Country'], notes: 'Medical Assistance · Local/regional MCO ecosystem (not Big Five dominated) · SDOH required',        expansion: true,  fpl: '138% FPL',            mcoModel: 'County-based',                 planCount: 10 },
  { state: 'Mississippi',     abbr: 'MS', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: false, hcbs: true,  mcPct: '~80%', mcos: ['Centene (Magnolia Health)', 'Molina', 'UHC'],                    notes: 'Mississippi CAN · No Medicaid expansion · SDOH not yet required · High elderly HCBS population',  expansion: false, fpl: '~27% FPL (parents)',  mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'Montana',         abbr: 'MT', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~72%', mcos: ['Centene (Montana)', 'PacificSource', 'Mountain Health CO-OP'],   notes: 'HELP Act expansion 2016 · Primarily rural frontier · SDOH required · Limited managed care history', expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'Nebraska',        abbr: 'NE', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~80%', mcos: ['Centene (Nebraska Total Care)', 'Molina', 'UHC'],                notes: 'Heritage Health · Ballot initiative expansion 2018 (effective 2020) · SDOH required',             expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'Nevada',          abbr: 'NV', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~86%', mcos: ['Centene (SilverSummit)', 'Molina', 'UHC', 'Anthem'],            notes: 'Nevada Medicaid · 1115 waiver · SDOH required · High uninsured rate pre-expansion',               expansion: true,  fpl: '138% FPL',            mcoModel: 'Regional (2 regions)',         planCount: 4  },
  { state: 'New Hampshire',   abbr: 'NH', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~85%', mcos: ['Centene (NH Healthy Families)', 'WellSense (BMC)', 'Granite State'], notes: 'NH Medicaid · High opioid-use disorder burden · Strong BH program · SDOH required',              expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'New Jersey',      abbr: 'NJ', evvModel: 'Open',            evvVendor: 'HHAeXchange',              sdoh: true,  hcbs: true,  mcPct: '~84%', mcos: ['Centene (WellCare NJ)', 'Aetna Better Health', 'Amerigroup', 'UHC', 'Horizon NJ Health'], notes: 'NJ FamilyCare · Strong BH parity · SDOH required · High dual eligible population', expansion: true,  fpl: '138% FPL',            mcoModel: 'Regional',                     planCount: 7  },
  { state: 'New Mexico',      abbr: 'NM', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~89%', mcos: ['Centene (Western Sky)', 'Molina', 'Presbyterian Community Care', 'UHC'], notes: 'Centennial Care 2.0 · SDOH required · High Native American and rural population · Strong HCBS', expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 4  },
  { state: 'North Dakota',    abbr: 'ND', evvModel: 'Provider Choice', evvVendor: 'Sandata',                  sdoh: false, hcbs: true,  mcPct: '~65%', mcos: ['Sanford Health Plan', 'Blue Cross Blue Shield ND'],              notes: 'Passport to Health · Limited managed care · Primarily rural frontier · SDOH not yet required',    expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide (limited)',          planCount: 2  },
  { state: 'Oklahoma',        abbr: 'OK', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~75%', mcos: ['Centene (OK Complete Health)', 'Aetna Better Health', 'UHC', 'Humana'], notes: 'SoonerSelect managed care launched 2023 · Medicaid expansion 2021 · SDOH required',              expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 4  },
  { state: 'Oregon',          abbr: 'OR', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~93%', mcos: ['PacificSource CCO', 'AllCare CCO', 'Trillium CCO', 'Columbia Pacific CCO', 'Eastern Oregon CCO'], notes: 'Oregon Health Plan · Unique CCO model (local non-profit MCOs) · Not Big Five dominated · SDOH required', expansion: true, fpl: '138% FPL', mcoModel: 'Regional (CCO model)', planCount: 16 },
  { state: 'Rhode Island',    abbr: 'RI', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~80%', mcos: ['UHC (Neighborhood Health)', 'Molina', 'Tufts Health'],            notes: 'RIte Care · One of first states with comprehensive Medicaid managed care · SDOH required',         expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'South Carolina',  abbr: 'SC', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: false, hcbs: true,  mcPct: '~78%', mcos: ['Centene (Absolute Total Care)', 'Molina', 'UHC', 'Select Health SC'], notes: 'Healthy Connections · No Medicaid expansion · SDOH not required · HCBS waiver active',           expansion: false, fpl: '~67% FPL (parents)',  mcoModel: 'Statewide',                    planCount: 4  },
  { state: 'South Dakota',    abbr: 'SD', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: false, hcbs: true,  mcPct: '~50%', mcos: ['Wellmark', 'Avera Health Plan'],                                  notes: 'Medicaid expansion started 2023 · Limited managed care historically · Rural frontier challenges',  expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide (limited)',          planCount: 2  },
  { state: 'Utah',            abbr: 'UT', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~82%', mcos: ['Centene (Summit Community Care)', 'Molina', 'UHC', 'SelectHealth'], notes: 'Utah Medicaid · Ballot initiative expansion 2018 (effective 2020) · SDOH required · Strong HCBS', expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 4  },
  { state: 'West Virginia',   abbr: 'WV', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~82%', mcos: ['Centene (WV Family Health)', 'Aetna Better Health', 'UniCare (Elevance)'], notes: 'Mountain Health Trust · SDOH required · High opioid crisis burden · BH parity active',           expansion: true,  fpl: '138% FPL',            mcoModel: 'Statewide',                    planCount: 3  },
  { state: 'Wisconsin',       abbr: 'WI', evvModel: 'Open',            evvVendor: 'Sandata',                  sdoh: true,  hcbs: true,  mcPct: '~80%', mcos: ['Centene (WellCare WI)', 'Molina', 'UHC', 'Amerigroup (Elevance)'], notes: 'BadgerCare Plus · Adults covered to 100% FPL (unique — not ACA expansion but broader than most non-expansion) · SDOH required', expansion: false, fpl: '~100% FPL (BadgerCare)', mcoModel: 'Regional', planCount: 7 },
